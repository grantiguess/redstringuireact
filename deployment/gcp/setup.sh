...
echo "   Production: https://redstring-prod-PROJECT_NUMBER.a.run.app/oauth/callback"
...
echo "   gcloud builds triggers describe redstring-prod-deploy"
echo ""
echo "4. Push to main branch to trigger production deployment!"
echo ""
echo -e "${GREEN}🎉 Your RedString app will be available at:${NC}"
echo -e "${GREEN}Production: https://redstring-prod-${PROJECT_NUMBER}.a.run.app${NC}"
